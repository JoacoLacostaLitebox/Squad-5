...
const PointsContainer = ({ points, loading }: PointsContainerProps) => {
  return (
    <div className="bg-fukuro-blue rounded-2xl px-6 py-8 flex flex-col gap-3 relative mt-4 mb-6 z-10 animate__animated animate__fadeIn">
