  ...
  return(
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-fukuro-white p-8 rounded-xl z-10 flex items-center flex-col gap-y-5">
        <h2 className={`text-lg font-bold mb-4 ${Phonk.className} text-fukuro-black`}>Atencion</h2>
        <p className={`${DMSans.className} text-fukuro-black`}>El item que escaneaste no es reutilizable, intentá nuevamente.</p>
